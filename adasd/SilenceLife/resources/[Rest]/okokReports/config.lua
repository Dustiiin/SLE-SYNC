...
Config.FeedbackClientCommand = 'support' -- The command that the players use to report something

Config.FeedbackAdminCommand = 'supports' -- The command that the admins use to check the pendent feedbacks list
