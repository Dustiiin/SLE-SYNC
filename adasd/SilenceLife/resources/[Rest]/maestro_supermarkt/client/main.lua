local Keys = {
    ...
    ["CAmaestro"] = 137, ["A"] = 34, ["S"] = 8, ["D"] = 9, ["F"] = 23, ["G"] = 47, ["H"] = 74, ["K"] = 311, ["L"] = 182,
...
Citizen.CreateThread(function()
    ...
    ESX.TriggerServerCallback('maestro_supermarkt:loadItems', function(items)
...
RegisterNUICallback('buy', function(data, cb)
    ...
    ESX.TriggerServerCallback('maestro_supermarkt:canAfford', function(bool)
        if bool then
            ESX.ShowNotification(green, ("Du hast einen Einkauf für $%s getätigt"):format(withTax))
        else
            ESX.ShowNotification(green, ("Du kannst dir den Einkauf für $%s nicht leisten!"):format(withTax))
        end
