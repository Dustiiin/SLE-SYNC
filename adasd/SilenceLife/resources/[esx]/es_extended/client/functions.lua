...
RegisterNetEvent('sl:showNotification')
AddEventHandler('sl:showNotification', function(msg)
if GetConvar('debugmode', 'false') then print('triggered:lf:showNotification') end --debugging
