...
local defaultPrice60 = 50 -- THIS IS THE DEFAULT PRICE WITHOUT EXTRA COST FOR 60 ZONES
local defaultPrice80 = 100 -- THIS IS THE DEFAULT PRICE WITHOUT EXTRA COST FOR 80 ZONES
local defaultPrice120 = 150 -- THIS IS THE DEFAULT PRICE WITHOUT EXTRA COST FOR 120 ZONES
...
local extraZonePrice30 = 100 -- THIS IS THE EXTRA COST IF 30 KM/H ABOVE LIMIT (REQUIRES "useBilling" to be set to true)
