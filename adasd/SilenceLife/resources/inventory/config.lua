...
-- Version / Important
Config.PlayerWeight = fales -- only works if you are using ESX 1.2 and above.
...
Config.WebhookURL = "https://discord.com/api/webhooks/1023022487623180288/Zhu-J6aEUREwZ9P9wdMeS_wfmrTahln_cGDBdFpfBhgO0Pzf8CaHfi1c84GdRI9HjwGV" -- discord webhook url
...
-- Rob
Config.HandsupKey = "home" -- default handsup key (users can change in their settings) | FiveM Keys
...
-- Trunk
Config.TrunkKey = "y" -- default trunk open key (users can change in their settings) | FiveM Keys
